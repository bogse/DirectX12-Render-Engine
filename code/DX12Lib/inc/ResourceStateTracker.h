...
public:
	...
	/**
	* Push a resource barrier to a resource state tracker.
	...
	*/
	...
	/**
	* Reset state tracking. This must be done when the commandList is reset.
	*/
	void Reset();

	/**
	* The global state must be locked before flushing the pending resource barriers
	...
	*/
	...
	/**
	* Unlocks the global resource state after the final states have been commited
	* to the global resource state array.
	*/
	static void Unlock();

	/**
	* Add a resource wit ha given state to the global resource state array (map).
	...
	*/
	...
	/**
	* Remove a resource from a global resource state array (map).
	...
	*/
	struct ResourceState
	{
		...
		*/
		...
		/**
		* Get the state of a (sub)resource withing the resource.
	...
	/**
	* The final (last know state) of the resources withing a command list.
