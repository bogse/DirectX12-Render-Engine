...
public:
	...
	*
	* Since the DynamicDescriptorHeap can't know which function will be used,
	* it must be passed as an argument to the function.
	* CommitStagedDescriptors should not be called directly, instead use the other two.
	*/
	...
	/**
	* Copies a single CPU descriptor to a GPU visible descriptor heap.
...
private:
	...
	*/
	struct DescriptorTableCache
	{
		...
		*/
		uint32_t NumDescriptors;
		/**
		* The pointer to the descriptor in the descriptor hadle cache.
		*/
	...
	* This parameter also determines the type of the GPU 
	* visible descriptor heap to create.
	*/
